...
st.title("🏭 SPC CPK Tool (Final Version)")
...
if archivo:
    ...
    # ===============================
    # AUTO-DETECCION BASEADA EN TU ARCHIVO REAL
    # ===============================
    ...
    if st.button("🚀 Calcular CPK"):
        ...
        if not df_valid.empty:
            ...
            step_sel = st.selectbox("Selecciona Test Step", df_valid["Test Step"])
